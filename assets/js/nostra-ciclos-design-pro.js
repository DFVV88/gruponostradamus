  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      body .tab-menu1.filter-menu-active{
        ...
        background:
          radial-gradient(circle at 12% 18%, rgba(0,194,209,.18), transparent 30%),
          radial-gradient(circle at 88% 12%, rgba(255,255,255,.55), transparent 22%),
          linear-gradient(135deg,#061426 0%,#082238 58%,#06353c 100%) !important;
        border:1px solid rgba(0,194,209,.28) !important;
        box-shadow:0 22px 55px rgba(0,0,0,.16),0 0 32px rgba(0,194,209,.12) !important;
      ...
      body .tab-menu1.filter-menu-active:before{
        content:'Selecciona un ciclo y mira la información completa';
        grid-column:1 / -1;
      ...
      body .tab-menu1.filter-menu-active:after{
        ...
        position:absolute;
        inset:0;
        background:linear-gradient(110deg,transparent 0%,rgba(255,255,255,.08) 46%,transparent 62%);
        transform:translateX(-130%);
        animation:nostraCiclosSweep 6s ease-in-out infinite;
        pointer-events:none;
      }
      ...
      body .tab-menu1.filter-menu-active .filter-btn{
        ...
        box-shadow:inset 0 1px 0 rgba(255,255,255,.08),0 9px 20px rgba(0,0,0,.13) !important;
      ...
      body .tab-menu1.filter-menu-active .filter-btn:before{
        ...
        border-radius:50%;
        background:#00d4df;
        box-shadow:0 0 12px rgba(0,212,223,.75);
      }
      ...
      body .tab-menu1.filter-menu-active .filter-btn.active{
        background:linear-gradient(135deg,#00c2d1,#008b96 52%,#045a69) !important;
        border-color:rgba(255,255,255,.28) !important;
        color:#ffffff !important;
        transform:translateY(-5px) scale(1.02) !important;
        box-shadow:0 16px 30px rgba(0,194,209,.22),0 0 24px rgba(0,194,209,.18) !important;
      }
      ...
      body .course-single-top{
        padding:20px !important;
        background:radial-gradient(circle at 12% 12%, rgba(0,194,209,.12), transparent 28%),linear-gradient(135deg,#f8ffff 0%,#eef9fb 100%) !important;
      }
      ...
      body .tab-content{
        border-radius:22px !important;
        background:radial-gradient(circle at 90% 8%, rgba(0,194,209,.09), transparent 24%),linear-gradient(180deg,#ffffff 0%,#f7fbfc 100%) !important;
      ...
      @keyframes nostraCiclosSweep{
        0%,42%{transform:translateX(-130%)}
        62%,100%{transform:translateX(130%)}
      }

      @media(min-width:1200px){
        body .tab-menu1.filter-menu-active{grid-template-columns:repeat(5,minmax(0,1fr)) !important;}
      }

      @media(min-width:992px) and (max-width:1199px){
        body .tab-menu1.filter-menu-active{grid-template-columns:repeat(3,minmax(0,1fr)) !important;}
        body .checklist ul{grid-template-columns:repeat(2,minmax(0,1fr)) !important;}
      }
      ...
      @media(max-width:991px){
        ...
        body .course-single-top,
        body .course-single-bottom{padding:16px !important;}
      ...
      @media(max-width:575px){
        ...
        body .course-description p,
        body .checklist li{font-size:14.5px !important;}
