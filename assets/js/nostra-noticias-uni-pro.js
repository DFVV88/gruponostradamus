...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      body.nostra-noticias-pro .nostra-news-note{
        ...
        color:#fff !important;
        text-align:center !important;
        box-shadow:0 20px 46px rgba(6,20,38,.14) !important;
      }
      ...
      @media(max-width:575px){
        body.nostra-noticias-pro .nostra-news-section{padding:58px 0 !important;}
  ...
  function replaceNews() {
    ...
    if (!wrapper || wrapper.dataset.nostraNoticiasPro === '1') return;

    var temp = document.createElement('div');
    temp.innerHTML = buildSection();
    var newSection = temp.firstChild;
    newSection.dataset.nostraNoticiasPro = '1';
