/* ==================================================
   ...
   Reemplaza SOLO las noticias antiguas del index.
   Evita tocar la sección de Preguntas Frecuentes.
================================================== */
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      body .nostra-index-news-section{
        ...
        background:radial-gradient(circle at 12% 0%, rgba(0,194,209,.16), transparent 34%),radial-gradient(circle at 88% 18%, rgba(0,139,150,.11), transparent 34%),linear-gradient(180deg,#f8fdff 0%,#ffffff 100%) !important;
        overflow:hidden !important;
      }
      body .nostra-index-news-head{display:grid !important;grid-template-columns:1fr auto !important;gap:24px !important;align-items:end !important;margin-bottom:38px !important;}
      body .nostra-index-news-kicker{display:inline-flex !important;align-items:center !important;gap:8px !important;margin-bottom:12px !important;color:#008b96 !important;font-size:15px !important;font-weight:950 !important;text-transform:uppercase !important;letter-spacing:.75px !important;}
      body .nostra-index-news-title{margin:0 !important;max-width:860px !important;color:#061426 !important;font-size:clamp(38px,4.6vw,72px) !important;line-height:1.02 !important;font-weight:950 !important;font-style:italic !important;text-transform:uppercase !important;letter-spacing:-1.2px !important;background:linear-gradient(180deg,#061426 0%,#0b3444 42%,#008b96 72%,#061426 100%) !important;-webkit-background-clip:text !important;background-clip:text !important;-webkit-text-fill-color:transparent !important;filter:drop-shadow(0 2px 0 rgba(255,255,255,.72)) !important;}
      body .nostra-index-news-title span{color:#008b96 !important;}
      body .nostra-index-news-cta{min-height:56px !important;display:inline-flex !important;align-items:center !important;justify-content:center !important;gap:10px !important;padding:15px 24px !important;border-radius:18px !important;background:linear-gradient(135deg,#008b96 0%,#05313d 55%,#061426 100%) !important;color:#fff !important;font-size:15px !important;font-weight:950 !important;text-transform:uppercase !important;text-decoration:none !important;box-shadow:0 18px 38px rgba(0,139,150,.22) !important;white-space:nowrap !important;}
      ...
      body .nostra-index-news-card{position:relative !important;min-height:390px !important;display:flex !important;flex-direction:column !important;padding:28px !important;border-radius:28px !important;background:linear-gradient(180deg,#ffffff,#f2fdff) !important;border:1px solid rgba(0,194,209,.24) !important;box-shadow:0 20px 50px rgba(6,20,38,.08),0 0 28px rgba(0,194,209,.08) !important;overflow:hidden !important;transition:transform .25s ease, box-shadow .25s ease, border-color .25s ease !important;}
      ...
      body .nostra-index-news-note{margin:36px auto 0 !important;max-width:980px !important;padding:20px 22px !important;border-radius:22px !important;background:linear-gradient(135deg,#061426,#083044 62%,#008b96) !important;color:#fff !important;text-align:center !important;box-shadow:0 22px 48px rgba(6,20,38,.15) !important;font-size:15.5px !important;font-weight:700 !important;line-height:1.55 !important;}
  ...
  function init() {
    ...
    if (!section || section.dataset.nostraIndexNoticiasPro === '3') return;
    section.classList.add('nostra-index-news-section');
    section.innerHTML = buildSection();
    section.dataset.nostraIndexNoticiasPro = '3';
  }
